  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        "amber-fire": "hsl(var(--amber-fire))",
        "deep-orange": "hsl(var(--deep-orange))",
        "royal-brown": "hsl(var(--royal-brown))",
        "deep-maroon": "hsl(var(--deep-maroon))",
        sandstone: "hsl(var(--sandstone))",
        parchment: "hsl(var(--parchment))",
        "warm-cream": "hsl(var(--warm-cream))",
        "temple-blue": "hsl(var(--temple-blue))",
        "peacock-teal": "hsl(var(--peacock-teal))",
        "ink-dark": "hsl(var(--ink-dark))",
        "muted-earth": "hsl(var(--muted-earth))",
        "heritage-gold": "hsl(var(--sun-gold))",
        "antique-gold": "hsl(var(--warm-gold))",
        primary: {
